...
try:
    ...
    for nome_interesse, cliente_id, nome_chave in chaves:
        ...
        cursor.execute("INSERT INTO licitacoes(id, cliente_id, nome_interesse, creation_time, n_registro, uasg, orgao, tipo_edital,edital, objeto, data_abertura, entrega, endereco, telefone, link, created_at, updated_at)\
                        SELECT 0,\
                        %s,\
                        '%s',\
                        CREATION_TIME,\
